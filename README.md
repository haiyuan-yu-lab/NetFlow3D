...
-------------- Part 1: PDB_ResDist.zip --------------
- IntraChain_ResDist (7,479 files)
...
- InterChain_ResDist (7,479 files)
Each file in this folder (file name format: UniProtID.graphml.gz) stores a residue-residue interaction network derived from PDB structures. Each network is built from a complete list of inter-chain interactions between the residues in the PDB chains of the protein indicated in the file name and the residues in other PDB chains. An interaction exists if the minimal inter-chain distance between two residues among all available PDB structures is smaller than 10 angstrom.
-----------------------------------------------------
...
----------------------- Part 2 ----------------------
- AF2-pLDDT0_IntraChain_ResDist_Part1.zip (10,373 files)
- AF2-pLDDT0_IntraChain_ResDist_Part2.zip (10,131 files)
Each file in this part (file name format: UniProtID.graphml.gz) stores a residue-residue interaction network derived from the structures in AlphaFold DB (https://alphafold.ebi.ac.uk/). The way of generating the files in this part is the same as that of generating the files in "IntraChain_ResDist" in Part 1. All residues in the AlphaFold DB structures are involved when generating this folder regardless of model confidence.
-----------------------------------------------------



-------- Part 3: PIONEER_PPI_Interfaces.txt ---------
This is a tab-separated file storing the protein-protein interaction interfaces obtained from PIONEER.
-----------------------------------------------------
